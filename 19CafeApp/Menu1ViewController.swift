...
class Menu1ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
let messages: Array<String> = ["빽다방만의 맛과 향을 더한 100% 아라비카 로스팅 원두로 뽑아내 깊고 진한 맛의 앗!메리카노",
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.view.makeToast(messages[indexPath.row], duration: 2.0, position: .bottom) // messages array의 indexpath.row로 인덱스를 가져와서 duration 2초간 position 바텀에 토스트를 띄어줌
